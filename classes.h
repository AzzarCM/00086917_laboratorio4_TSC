...
enum parameters {LEN,TAU,KAPPA,LAMBDA,NU,PSI,ALFA,DELTA,NI};
...
class mesh{
    ...
    public:
        void setParameters(float l,float tau,float kappa,float lambda,float nu,float psi,float alfa,float delta,float ni){
                parameters[LEN]=l;
                parameters[TAU]=tau;
